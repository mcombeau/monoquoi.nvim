...
function module.get_groups()
    ...
    groups.terminal_color_0 = colors.black0
    groups.terminal_color_8 = colors.gray2
    ...
    groups.terminal_color_4 = colors.blue0
    groups.terminal_color_12 = colors.blue2
    ...
    groups.terminal_color_7 = colors.white0
    groups.terminal_color_15 = colors.white1
